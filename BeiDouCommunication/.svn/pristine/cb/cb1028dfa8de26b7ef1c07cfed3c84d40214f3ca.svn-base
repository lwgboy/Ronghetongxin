...
public class SidePullDelListViewofcopy extends ListView {
    /**
     * 用户滑动的最小距离
     */
    ...
    public SidePullDelListViewofcopy(Context context) {
        super(context);
    }

    public SidePullDelListViewofcopy(Context context, AttributeSet attrs) {
        super(context, attrs);
        mInflater = LayoutInflater.from(context);
        // 获取设备所支持的最小滑动距离
        touchSlop = ViewConfiguration.get(context).getScaledTouchSlop();

        View view = mInflater.inflate(R.layout.sidepull_del_button, null);
        mDelBtn = (Button) view.findViewById(R.id.btn_side_pull_del);
        //
    ...
    public SidePullDelListViewofcopy(Context context, AttributeSet attrs, int defStyleAttr) {
