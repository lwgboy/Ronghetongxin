...
public class SidePullDelListView extends ListView {
    ...
    public SidePullDelListView(Context context) {
        super(context);
        init(context);
    }

    public SidePullDelListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public SidePullDelListView(Context context, AttributeSet attrs, int defStyleAttr) {
