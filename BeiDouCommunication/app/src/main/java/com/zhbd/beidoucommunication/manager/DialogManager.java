...
//    private ImageView mVoice;
    ...
    public void showRecordingDialog() {
        //根据指定sytle实例化Dialog
        mDialog = new Dialog(mContext, R.style.Theme_AndioDialog);
        LayoutInflater inflater = LayoutInflater.from(mContext);
        View view = inflater.inflate(R.layout.dialog_recorder, null);
        mDialog.setContentView(view);
        mIcon = (ImageView) view.findViewById(R.id.mic_image_left);
//        mVoice = (ImageView) view.findViewById(R.id.mic_image_right);
        mLable = (TextView) view.findViewById(R.id.recording_hint);
        mDialog.show();
    }
...
//            mVoice.setVisibility(View.VISIBLE);
            ...
            mLable.setBackgroundColor(Color.parseColor("#00000000"));
        }
    }
...
//            mVoice.setVisibility(View.GONE);
            ...
            mLable.setBackgroundColor(Color.parseColor("#66ff0000"));
        }
    }
...
//            mVoice.setVisibility(View.GONE);
            ...
            mLable.setText(R.string.speak_to_short);
            mLable.setBackgroundColor(Color.parseColor("#00000000"));
        }
    }
